...
export function Gauge({
  ...
  // Semicircle: only use half the donut, scale value accordingly
  const filledAngle = (clamped / 100) * 180;
  const data = [
    { name: "filled", value: filledAngle },
    { name: "empty", value: 180 - filledAngle },
  ];

  return (
    <div className="relative inline-flex items-center justify-center" style={{ height: half + outerRadius * 0.2 }}>
